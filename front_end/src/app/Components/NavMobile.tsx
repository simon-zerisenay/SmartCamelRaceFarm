...
const NavMobile = ({ isOpen, setOpen }: NavMobileProps) => {
  return (
    <div className='md:hidden text-black dark:text-white '>
      ...
      {isOpen && (
        <div className='fixed left-0 right-0  p-5 pt-0  bg-slate-50 bg-opacity-100 dark:bg-black dark:border-t-[1px] dark:border-gray-100'>
          ...
          <Link href='/Login'>
            <button className=' border-[1px] dark:border-gray-100 border-gray-900 rounded-full  text-3xl font-medium  cursor-pointer py-4 px-7'>Log In</button>
          </Link>
          <Link href='/SignUp'>
